...
<body>
<p>Ejemplo de XHTML y JavaScript</p>
<p>El código en JavaScript se ejecuta en el cliente (navegador) y es visible el código fuente, se puede visualizar las funciones y ver como están programadas.</p>
